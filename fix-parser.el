...
(defvar fix-parser/fix-value-dictionary-4.4
  (let ((dict (make-hash-table :test 'equal)))
    (puthash "35" (let ((val-dict (make-hash-table :test 'equal)))
                    (puthash "0" "Heartbeat" val-dict)
                    (puthash "1" "Test Request" val-dict)
                    (puthash "2" "Resend Request" val-dict)
                    (puthash "3" "Reject" val-dict)
                    (puthash "4" "Sequence Reset" val-dict)
                    (puthash "5" "Logout" val-dict)
                    (puthash "6" "IOI" val-dict)
                    (puthash "7" "Advertisement" val-dict)
                    (puthash "8" "Execution Report" val-dict)
                    (puthash "9" "Order Cancel Reject" val-dict)
                    (puthash "A" "Logon" val-dict)
                    (puthash "B" "News" val-dict)
                    (puthash "C" "Email" val-dict)
                    (puthash "D" "New Order Single" val-dict)
                    (puthash "E" "New Order List" val-dict)
                    (puthash "F" "Order Cancel Request" val-dict)
                    (puthash "G" "Order Cancel/Replace Request" val-dict)
                    (puthash "H" "Order Status Request" val-dict)
                    (puthash "J" "Allocation Instruction" val-dict)
                    (puthash "K" "List Cancel Request" val-dict)
                    (puthash "L" "List Execute" val-dict)
                    (puthash "M" "List Status Request" val-dict)
                    (puthash "N" "List Status" val-dict)
                    (puthash "P" "Allocation Instruction Ack" val-dict)
                    (puthash "Q" "Don't Know Trade (DK)" val-dict)
                    (puthash "R" "Quote Request" val-dict)
                    (puthash "S" "Quote" val-dict)
                    (puthash "T" "Settlement Instructions" val-dict)
                    (puthash "V" "Market Data Request" val-dict)
                    (puthash "W" "Market Data Snapshot/Full Refresh" val-dict)
                    (puthash "X" "Market Data Incremental Refresh" val-dict)
                    (puthash "Y" "Market Data Request Reject" val-dict)
                    (puthash "Z" "Quote Cancel" val-dict)
                    (puthash "a" "Quote Status Request" val-dict)
                    (puthash "b" "Mass Quote Acknowledgement" val-dict)
                    (puthash "c" "Security Definition Request" val-dict)
                    (puthash "d" "Security Definition" val-dict)
                    (puthash "e" "Security Status Request" val-dict)
                    (puthash "f" "Security Status" val-dict)
                    (puthash "g" "Trading Session Status Request" val-dict)
                    (puthash "h" "Trading Session Status" val-dict)
                    (puthash "i" "Mass Quote" val-dict)
                    (puthash "j" "Business Message Reject" val-dict)
                    (puthash "k" "Bid Request" val-dict)
                    (puthash "l" "Bid Response (lowercase L)" val-dict)
                    (puthash "m" "List Strike Price" val-dict)
                    (puthash "n" "XML non-FIX" val-dict)
                    (puthash "o" "Registration Instructions" val-dict)
                    (puthash "p" "Registration Instructions Response" val-dict)
                    (puthash "q" "Order Mass Cancel Request" val-dict)
                    (puthash "r" "Order Mass Cancel Report" val-dict)
                    (puthash "s" "New Order Cross" val-dict)
                    (puthash "t" "Cross Order Cancel/Replace Request" val-dict)
                    (puthash "u" "Cross Order Cancel Request" val-dict)
                    (puthash "v" "Security Type Request" val-dict)
                    (puthash "w" "Security Types" val-dict)
                    (puthash "x" "Security List Request" val-dict)
                    (puthash "y" "Security List" val-dict)
                    (puthash "z" "Derivative Security List Request" val-dict)
                    (puthash "AA" "Derivative Security List" val-dict)
                    (puthash "AB" "New Order Multileg" val-dict)
                    (puthash "AC" "Multileg Order Cancel/Replace" val-dict)
                    (puthash "AD" "Trade Capture Report Request" val-dict)
                    (puthash "AE" "Trade Capture Report" val-dict)
                    (puthash "AF" "Order Mass Status Request" val-dict)
                    (puthash "AG" "Quote Request Reject" val-dict)
                    (puthash "AH" "RFQ Request" val-dict)
                    (puthash "AI" "Quote Status Report" val-dict)
                    (puthash "AJ" "Quote Response" val-dict)
                    (puthash "AK" "Confirmation" val-dict)
                    (puthash "AL" "Position Maintenance Request" val-dict)
                    (puthash "AM" "Position Maintenance Report" val-dict)
                    (puthash "AN" "Request For Positions" val-dict)
                    (puthash "AO" "Request For Positions Ack" val-dict)
                    (puthash "AP" "Position Report" val-dict)
                    (puthash "AQ" "Trade Capture Report Request Ack" val-dict)
                    (puthash "AR" "Trade Capture Report Ack" val-dict)
                    (puthash "AS" "Allocation Report" val-dict)
                    (puthash "AT" "Allocation Report Ack" val-dict)
                    (puthash "AU" "Confirmation Ack" val-dict)
                    (puthash "AV" "Settlement Instruction Request" val-dict)
                    (puthash "AW" "Assignment Report" val-dict)
                    (puthash "AX" "Collateral Request" val-dict)
                    (puthash "AY" "Collateral Assignment" val-dict)
                    (puthash "AZ" "Collateral Response" val-dict)
                    (puthash "BA" "Collateral Report" val-dict)
                    (puthash "BB" "Collateral Inquiry" val-dict)
                    (puthash "BC" "Network Counterparty System Status Request" val-dict)
                    (puthash "BD" "Network Counterparty System Status Response" val-dict)
                    (puthash "BE" "User Request" val-dict)
                    (puthash "BF" "User Response" val-dict)
                    (puthash "BG" "Collateral Inquiry Ack" val-dict)
                    (puthash "BH" "Confirmation Request" val-dict)
                    val-dict) dict)
    dict)
  "A hash table mapping FIX 4.4 tag numbers to their value dictionaries.")
...
formatted org-mode table. If it's invalid, return nil."
  (let* ((trimmed-message (string-trim raw-message))
    ...
    (when (and trimmed-message
               ...
               (string-match-p "[|\n\r\001]9=" trimmed-message)
               (string-match-p "[|\n\r\001]10=" trimmed-message))

      ;; Use a regex for separators to handle SOH, pipes, newlines, etc.
          ...
          (let* ((tag-val (split-string pair "="))
            ...
            (when (and tag val)
              (let* ((tag-name (gethash tag fix-parser/fix-tag-dictionary-4.4 "Unknown Tag"))
                     (val-dict (gethash tag fix-parser/fix-value-dictionary-4.4))
                     (val-name (if val-dict (gethash val val-dict) nil))
                     (col1-str (format "%s (%s)" tag tag-name))
                     (col2-str (if val-name (format "%s (%s)" val val-name) val)))
                (push (list col1-str col2-str) parsed-data)
                ;; Update max widths
                (setq col1-width (max col1-width (length col1-str)))
                (setq col2-width (max col2-width (length col2-str))))))))
...
parses each one.  The message is expected to use '|' as the field separator."
  ...
  (let ((output-buffer-name "*fix-parse-result*")
    ...
    (if (use-region-p)
      ...
      (save-excursion
        (goto-char (point-min))
        (while (re-search-forward "8=FIX" nil t)
          (let* ((start (match-beginning 0))
                 (end (save-excursion (re-search-forward "10=\\([0-9]+\\)|" nil t) (match-end 0)))
                 (raw-message (buffer-substring-no-properties start end))
                 (table (fix-parser/parse-fix--to-table-string raw-message)))
            (when table
              (push table tables)))))
